...
export class UserService {
  ...
  sendUser(data: any): Observable<any> {
    return this.http.post<User>('https://evenu-website-6.onrender.com/users/login', data).pipe(
      tap((resData) => {
        const user = new User(
          resData.email,
          resData.id,
  ...
  getReviews(): Observable<any> {
    return this.http.get('https://evenu-website-6.onrender.com/users/1/review');
  }
  ...
  getOneUser(id: any): Observable<any> {
    return this.http.get(`https://evenu-website-6.onrender.com/users/${id}`);
  }

  setReveiw(id: any, data: any): Observable<any> {
    return this.http.post(`https://evenu-website-6.onrender.com/users/${id}/review`, data);
  }
